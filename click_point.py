...
#from get_corridor import func_corridor
#from calib_utils import select_coords, draw_img_line, concurent_condition, dist2corrected, sumdists
...
pts_name_b = f"pts_{i_frame[i]}_b.npy"
...
if annot:
    ...
    pts = np.column_stack((idents, pts))
    np.save(pts_name_b, pts)