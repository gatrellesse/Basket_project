...
from Player_Detection.utils.yolo6_utils import check_img_size, process_image_array

video_in = "../Terrain_Detection/src/data/videos/basket_game.mp4"
supervis= False
if supervis:
    ...
    PLAYER_DETECTION_MODEL_PATH = '/home/fenaux/Documents/foot/sports-main/examples/soccer/data/football-player-detection.pt'
    #PLAYER_DETECTION_MODEL_PATH = '../Player_Detection/weights/xxx.pt"
...
## BOTA BOXES NO PLAYER_DETECTION/DATA/ANNOTATIONS
func_box(video_in, '../data/annotations/boxes.npy', start_frame=100_001, end_frame=100_001+2000)